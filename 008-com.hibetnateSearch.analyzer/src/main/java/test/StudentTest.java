...
public class StudentTest {
	...
	public static void main(String[] args) {
		...
		Student ogrenci = new Student("Ferhat", "Aykan", new Date(), lessons, phoneNumbers1, "aykanferhat@gmail.com");
		Student ogrenci1 = new Student("Ahmet", "Deniz", new Date(), lessons, phoneNumbers2, "kitaplar");
