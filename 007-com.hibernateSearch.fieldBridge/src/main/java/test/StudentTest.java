...
public class StudentTest {
	...
	public static void main(String[] args) {
		...
		Student ogrenci = new Student("Ferhat", "Aykan", new Date(), lessons, phoneNumbers1);
		Student ogrenci1 = new Student("Ahmet", "Deniz", new Date(), lessons, phoneNumbers2);
		...
		org.apache.lucene.search.Query query = qb.keyword()
															.onFields("firstName", "lastName", "lessons.lessonName", "lessons.teacherName", "phoneNumber")
															.matching("03333333333")
															.createQuery();
